...
//==============================================================================
class MainHostWindow::PluginListWindow  : public DocumentWindow //RIGHT CLICK WINDOW WITH PLUGINS
{
public:
                      ...
                      DocumentWindow::allButtons)
{
   ...
   #if JUCE_MAC
    setMacMainMenu (this);
   #else                            //menu bar options (file, options, edit, etc)
    setMenuBar (this);
   #endif
...
PopupMenu MainHostWindow::getMenuForIndex (int topLevelMenuIndex, const String& /*menuName*/)
{
    ...
    else if (topLevelMenuIndex == 1)
    {
        ...
        menu.addSubMenu ("Create plugin", pluginsMenu); //PLUGINS MENU
        menu.addSeparator();
